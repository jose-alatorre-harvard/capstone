...
from lib.Environment_refactored import DeepTradingEnvironment, LinearAgent,DeepAgent
import datetime
import numpy as np
...
deep_agent=DeepAgent(environment=env,out_reward_window_td=out_reward_window,
